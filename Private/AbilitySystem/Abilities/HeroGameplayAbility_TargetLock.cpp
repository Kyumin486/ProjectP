...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	...
	if (bShouldOverrideRotation)
	{
		...
		//{
		//	
		//	//TargetLockCameraOffsetDistance = 30;
		//	TargetLockCameraOffsetDistance = FMath::FInterpTo(TargetLockCameraOffsetDistance, 40, DeltaTime, 1);
		//}
		//else
		//{
		//	TargetLockCameraOffsetDistance = 20;
		//}
