...
void UWarriorAbilitySystemComponent::SetAbilityLevelByTag(FGameplayTag AbilityTag)
{
...
UGameplayAbility* UWarriorAbilitySystemComponent::FindAbilityByTag(FGameplayTag AbilityTag)
{
	for (FGameplayAbilitySpec& Spec : ActivatableAbilities.Items)
	{
		if (Spec.Ability->AbilityTags.HasTagExact(AbilityTag))
