...
void UWarriorFunctionLibrary::BP_DoesActorHaveTag(AActor* InActor, FGameplayTag TagToCheck, EWarriorConfirmType& OutComfirmType)
{
	OutComfirmType = NativeDoesActorHaveTag(InActor, TagToCheck) ? EWarriorConfirmType::Yes : EWarriorConfirmType::No;
}

UPawnCombatComponent* UWarriorFunctionLibrary::NativeGetPawnCombatCombponentFromActor(AActor* InActor)
{
	check(InActor);
...
UPawnCombatComponent* UWarriorFunctionLibrary::BP_GetPawnCombatCombponentFromActor(AActor* InActor, EWarriorValidType& OutValidType)
{
	UPawnCombatComponent* CombatComponent = NativeGetPawnCombatCombponentFromActor(InActor);
...
UCharacterMovementComponent* UWarriorFunctionLibrary::GetCharacterMovementComponent(AActor* Player)
{
	if (Cast<AWarriorHeroCharacter>(Player))
	{
		return Cast<AWarriorHeroCharacter>(Player)->GetCharacterMovement();
	}
	return nullptr;
}
