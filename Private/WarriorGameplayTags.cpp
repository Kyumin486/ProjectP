...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Katana_Light, "InputTag.SpecialWeaponAbility.Katana.Light");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Katana_Heavy, "InputTag.SpecialWeaponAbility.Katana.Heavy");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Katana_Third, "InputTag.SpecialWeaponAbility.Katana.Third");	

	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Bow_Light, "InputTag.SpecialWeaponAbility.Bow.Light");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Bow_Heavy, "InputTag.SpecialWeaponAbility.Bow.Heavy");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWeaponAbility_Bow_Third, "InputTag.SpecialWeaponAbility.Bow.Third");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Katana_Light, "Player.Cooldown.SpecialWeaponAbility.Katana.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Katana_Heavy, "Player.Cooldown.SpecialWeaponAbility.Katana.Heavy");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Katana_Third, "Player.Cooldown.SpecialWeaponAbility.Katana.Third");

	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Bow_Light, "Player.Cooldown.SpecialWeaponAbility.Bow.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Bow_Heavy, "Player.Cooldown.SpecialWeaponAbility.Bow.Heavy");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWeaponAbility_Bow_Third, "Player.Cooldown.SpecialWeaponAbility.Bow.Third");
