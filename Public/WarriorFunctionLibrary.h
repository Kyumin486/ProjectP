 ...
 */
UCLASS()
class PROJECTP_API UWarriorFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static UPawnCombatComponent* NativeGetPawnCombatCombponentFromActor(AActor* InActor);

	UFUNCTION(BlueprintCallable, Category = "Warrior|FunctionLibrary", meta = (DisplayName = "Get Pawn Combat Combponent From Actor", ExpandEnumAsExecs = "OutValidType"))
	static UPawnCombatComponent* BP_GetPawnCombatCombponentFromActor(AActor* InActor, EWarriorValidType& OutValidType);
	...
	UFUNCTION(BlueprintPure, Category = "Warrior|FunctionLibrary")
	static UCharacterMovementComponent* GetCharacterMovementComponent(AActor* Player);
